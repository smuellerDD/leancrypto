...
enum pkcs7_actions {
	...
	ACT_pkcs7_sig_note_authenticated_attr_continue = 19,
	ACT_pkcs7_sig_note_digest_algo = 20,
	ACT_pkcs7_sig_note_issuer = 21,
	ACT_pkcs7_sig_note_pkey_algo = 22,
	ACT_pkcs7_sig_note_pkey_algo_OID = 23,
	ACT_pkcs7_sig_note_serial = 24,
	ACT_pkcs7_sig_note_set_of_authattrs = 25,
	ACT_pkcs7_sig_note_signature = 26,
	ACT_pkcs7_sig_note_skid = 27,
	NR__pkcs7_actions = 28
};
...
static const asn1_action_t pkcs7_action_table[NR__pkcs7_actions] = {
	...
	[  19] = pkcs7_sig_note_authenticated_attr_continue,
	[  20] = pkcs7_sig_note_digest_algo,
	[  21] = pkcs7_sig_note_issuer,
	[  22] = pkcs7_sig_note_pkey_algo,
	[  23] = pkcs7_sig_note_pkey_algo_OID,
	[  24] = pkcs7_sig_note_serial,
	[  25] = pkcs7_sig_note_set_of_authattrs,
	[  26] = pkcs7_sig_note_signature,
	[  27] = pkcs7_sig_note_skid,
};
...
static const asn1_action_enc_t pkcs7_action_table_enc[NR__pkcs7_actions] = {
	...
	[  19] = pkcs7_sig_note_authenticated_attr_continue_enc,
	[  20] = pkcs7_sig_note_digest_algo_enc,
	[  21] = pkcs7_sig_note_issuer_enc,
	[  22] = pkcs7_sig_note_pkey_algo_enc,
	[  23] = pkcs7_sig_note_pkey_algo_OID_enc,
	[  24] = pkcs7_sig_note_serial_enc,
	[  25] = pkcs7_sig_note_set_of_authattrs_enc,
	[  26] = pkcs7_sig_note_signature_enc,
	[  27] = pkcs7_sig_note_skid_enc,
};
...
static const unsigned char pkcs7_machine[] = {
	...
	[ 196] =  _jump_target(223),		// --> AuthenticatedAttribute
	[ 197] =  ASN1_OP_ACT,
	[ 198] =  _action(ACT_pkcs7_sig_note_authenticated_attr_continue),
	[ 199] = ASN1_OP_END_SET_OF,
	[ 200] = _jump_target(194),
	[ 201] = ASN1_OP_RETURN,

	[ 202] =  ASN1_OP_MATCH,		// aaSequence
	[ 203] =  _tag(UNIV, CONS, SEQ),
	// AuthenticatedAttribute
	[ 204] =   ASN1_OP_MATCH_JUMP,
	[ 205] =   _tag(UNIV, CONS, SEQ),
	[ 206] =   _jump_target(223),		// --> AuthenticatedAttribute
	[ 207] =  ASN1_OP_END_SEQ_OF,
	[ 208] =  _jump_target(204),
	[ 209] = ASN1_OP_END_SEQ,
	[ 210] = ASN1_OP_RETURN,

	// UnauthenticatedAttribute
	[ 211] =  ASN1_OP_MATCH_JUMP,
	[ 212] =  _tag(UNIV, CONS, SEQ),
	[ 213] =  _jump_target(234),		// --> UnauthenticatedAttribute
	[ 214] = ASN1_OP_END_SET_OF,
	[ 215] = _jump_target(211),
	[ 216] = ASN1_OP_RETURN,

	// UnauthenticatedAttribute
	[ 217] =  ASN1_OP_MATCH_JUMP,
	[ 218] =  _tag(UNIV, CONS, SEQ),
	[ 219] =  _jump_target(234),		// --> UnauthenticatedAttribute
	[ 220] = ASN1_OP_END_SEQ_OF,
	[ 221] = _jump_target(217),
	[ 222] = ASN1_OP_RETURN,

	[ 223] =  ASN1_OP_MATCH_ACT,		// type
	[ 224] =  _tag(UNIV, PRIM, OID),
	[ 225] =  _action(ACT_pkcs7_authenticated_attr_OID),
	[ 226] =  ASN1_OP_MATCH,		// values
	[ 227] =  _tag(UNIV, CONS, SET),
	[ 228] =   ASN1_OP_MATCH_ANY_ACT,
	[ 229] =   _action(ACT_pkcs7_sig_note_authenticated_attr),
	[ 230] =  ASN1_OP_END_SET_OF,
	[ 231] =  _jump_target(228),
	[ 232] = ASN1_OP_END_SEQ,
	[ 233] = ASN1_OP_RETURN,

	[ 234] =  ASN1_OP_MATCH,		// type
	[ 235] =  _tag(UNIV, PRIM, OID),
	[ 236] =  ASN1_OP_MATCH,		// values
	[ 237] =  _tag(UNIV, CONS, SET),
	[ 238] =   ASN1_OP_MATCH_ANY,
	[ 239] =  ASN1_OP_END_SET_OF,
	[ 240] =  _jump_target(238),
	[ 241] = ASN1_OP_END_SEQ,
	[ 242] = ASN1_OP_RETURN,
};
