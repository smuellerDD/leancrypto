...
enum pkcs7_aa_actions {
	ACT_pkcs7_separate_aa = 0,
	ACT_pkcs7_separate_aa_OID = 1,
	ACT_pkcs7_separate_aa_continue = 2,
	NR__pkcs7_aa_actions = 3
};

static const asn1_action_t pkcs7_aa_action_table[NR__pkcs7_aa_actions] = {
	[   0] = pkcs7_separate_aa,
	[   1] = pkcs7_separate_aa_OID,
	[   2] = pkcs7_separate_aa_continue,
};

static const asn1_action_enc_t pkcs7_aa_action_table_enc[NR__pkcs7_aa_actions] = {
	[   0] = pkcs7_separate_aa_enc,
	[   1] = pkcs7_separate_aa_OID_enc,
	[   2] = pkcs7_separate_aa_continue_enc,
};
...
static const unsigned char pkcs7_aa_machine[] = {
	...
	[   6] =   _action(ACT_pkcs7_separate_aa_OID),
	[   7] =   ASN1_OP_MATCH,		// values
	[   8] =   _tag(UNIV, CONS, SET),
	[   9] =    ASN1_OP_MATCH_ANY_ACT,
	[  10] =    _action(ACT_pkcs7_separate_aa),
	[  11] =   ASN1_OP_END_SET_OF,
	[  12] =   _jump_target(9),
	[  13] =  ASN1_OP_END_SEQ_ACT,
	[  14] =  _action(ACT_pkcs7_separate_aa_continue),
