...
{
	{
		...
		.ss.ss = {
			0xf3, 0x84, 0xe0, 0xca, 0x18, 0xd7, 0xa9, 0x07,
			0x33, 0xa5, 0xb4, 0xb0, 0xb7, 0xfb, 0xf0, 0x14,
			0x29, 0x90, 0xc4, 0x0c, 0xaa, 0x64, 0x64, 0x89,
			0x5c, 0x8d, 0x44, 0xc7, 0x20, 0x32, 0x1e, 0xaa,
			},
	},
};
#endif
