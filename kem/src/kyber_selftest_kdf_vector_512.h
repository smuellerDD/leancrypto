...
{
	{
		...
		.ss.ss = {
			0x81, 0xcf, 0x79, 0x3f, 0xcb, 0x71, 0xf1, 0xea,
			0xe9, 0xb7, 0xd9, 0xdd, 0x70, 0x95, 0x3d, 0xe2,
			0xcd, 0xc0, 0xb2, 0x72, 0xeb, 0x4f, 0xd6, 0x84,
			0xb4, 0x31, 0xd0, 0x89, 0x33, 0x7c, 0x02, 0x1c,
			},
	},
};
#endif
