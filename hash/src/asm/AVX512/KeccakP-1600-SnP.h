...
#define KeccakP1600_AVX512_implementation      "AVX-512 optimized implementation"
#define KeccakP1600_AVX512_stateSizeInBytes    200
#define KeccakP1600_AVX512_stateAlignment      8
#define KeccakF1600_FastLoop_supported
#define KeccakP1600_AVX512_12rounds_FastLoop_supported

#define KeccakP1600_AVX512_StaticInitialize()
FORCE_SYSV void KeccakP1600_AVX512_Initialize(void *state);
...
FORCE_SYSV void KeccakP1600_AVX512_AddBytes(void *state, const unsigned char *data, unsigned int offset, unsigned int length);
FORCE_SYSV void KeccakP1600_AVX512_OverwriteBytes(void *state, const unsigned char *data, unsigned int offset, unsigned int length);
FORCE_SYSV void KeccakP1600_AVX512_OverwriteWithZeroes(void *state, unsigned int byteCount);
